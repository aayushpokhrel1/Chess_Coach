...
function findWasmBinary() {
  ...
  if (Module['locateFile']) {
    return locateFile('chesscoach.wasm');
  }

  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('chesscoach.wasm', import.meta.url).href;
...
var _uci_command = Module['_uci_command'] = makeInvalidEarlyAccess('_uci_command');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['uci_command'] != 'undefined', 'missing Wasm export: uci_command');
  ...
  _uci_command = Module['_uci_command'] = createExportWrapper('uci_command', wasmExports['uci_command'], 1);
